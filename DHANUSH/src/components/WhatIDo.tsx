        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Developing AI-driven applications using machine learning, deep
                learning, NLP, and computer vision. From model training to
                deployment, I build scalable AI solutions.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building robust APIs and cloud-based solutions. From GCP
                deployments to backend services, I deliver production-ready
                infrastructure.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
